...
class Student:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Student Management System", bd=10, relief=GROOVE,
                      font=("times new roman", 40, "bold"), bg="black", fg="yellow")
        ...
        lbl_roll = Label(Manage_Frame, text="Roll No.", bg="yellow", fg="black", font=("times new roman", 15, "bold"))
        ...
        lbl_Email = Label(Manage_Frame, text="Email", bg="yellow", fg="black", font=("times new roman", 15, "bold"))
        ...
        lbl_Contact = Label(Manage_Frame, text="Contact", bg="yellow", fg="black", font=("times new roman", 15, "bold"))
        ...
        lbl_DOB = Label(Manage_Frame, text="D.O.B", bg="yellow", fg="black", font=("times new roman", 15, "bold"))
        ...
        lbl_Address = Label(Manage_Frame, text="Address", bg="yellow", fg="black", font=("times new roman", 15, "bold"))
        ...
        lbl_search = Label(Detail_Frame, text="Search By", bg="yellow", fg="black",
